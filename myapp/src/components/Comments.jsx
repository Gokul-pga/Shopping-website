...
function Comments() {
  return (
    <>
    <Stack flex={1}  sx={{borderRadius:'0 20px 20px 0',margin:'5px'}}>
    <Box sx={{display:'flex',flexDirection:'column',position:'fixed' ,backgroundColor: '#e6e6e6',width:'350px',height:'100vh',borderRadius:'20px 0 0 20px',padding:'10px'}}>
